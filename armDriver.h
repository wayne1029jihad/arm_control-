...
public:
    ...
    /*add by wayne begin*/
    //linearmode can control how many mm to move at (X,Y)
    void linearMode(float X, float Y);
    void moveMode(float X, float Y, float Z, float mode);
    void angleMode(float base, float rear, float fore, float mode);
private:
